...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'orm', 'user' => 'root', 'password' => 'toor', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/BG/PlateformBundle/Resources/config/doctrine') => 'BG\\PlateformBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'BG\\PlateformBundle\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/BG/UserBundle/Entity'))), 'BG\\UserBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('BGPlateformBundle' => 'BG\\PlateformBundle\\Entity', 'BGUserBundle' => 'BG\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bf8cbcc946cd849c1be4aad744a8939bdb26fe62710055a192d131d260f2a44b');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('BG\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('BG\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('BG\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('BG\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'BG\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/BG/PlateformBundle/Resources/views'), 'BGPlateform');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/BG/UserBundle/Resources/views'), 'BGUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('984b18b7a61f0fd17521bf23536f0463ace5ab3b');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BGPlateformBundle' => 'BG\\PlateformBundle\\BGPlateformBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'BGUserBundle' => 'BG\\UserBundle\\BGUserBundle',
            ...
            'locale' => 'fr',
            'secret' => '984b18b7a61f0fd17521bf23536f0463ace5ab3b',
            ...
            'kernel.secret' => '984b18b7a61f0fd17521bf23536f0463ace5ab3b',
            ...
            'fos_user.model.user.class' => 'BG\\UserBundle\\Entity\\User',
